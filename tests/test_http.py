...
class TestSyncHttpClient:
    ...
    def test_get_success(self):
        ...
        client = SyncHttpClient("https://api.mailgent.dev", "mgnt-test")
    ...
    def test_auth_header(self):
        ...
        client = SyncHttpClient("https://api.mailgent.dev", "mgnt-secret")
        client.get("/v0/whoami")
        assert route.calls[0].request.headers["authorization"] == "Bearer mgnt-secret"
        client.close()
    ...
    def test_error_raises(self):
        ...
        client = SyncHttpClient("https://api.mailgent.dev", "mgnt-bad")
        with pytest.raises(MailgentApiError) as exc_info:
            client.get("/v0/whoami")
...
class TestAsyncHttpClient:
    ...
    async def test_get_success(self):
        respx.get("https://api.mailgent.dev/v0/whoami").mock(
            return_value=httpx.Response(200, json={"identityId": "id-123"}))
        client = AsyncHttpClient("https://api.mailgent.dev", "mgnt-test")
