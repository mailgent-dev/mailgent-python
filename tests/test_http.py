...
import pytest
import respx
from hivekey._http import SyncHttpClient, AsyncHttpClient
...
class TestSyncHttpClient:
    ...
    def test_get_success(self):
        respx.get("https://api.hivekey.ai/v0/whoami").mock(
            return_value=httpx.Response(200, json={"identityId": "id-123"}))
        client = SyncHttpClient("https://api.hivekey.ai", "mgent-test")
    ...
    def test_auth_header(self):
        route = respx.get("https://api.hivekey.ai/v0/whoami").mock(
            return_value=httpx.Response(200, json={}))
        client = SyncHttpClient("https://api.hivekey.ai", "mgent-secret")
    ...
    def test_post_with_body(self):
        respx.post("https://api.hivekey.ai/v0/messages/send").mock(
    ...
    def test_delete_204(self):
        respx.delete("https://api.hivekey.ai/v0/messages/msg-1").mock(
    ...
    def test_error_raises(self):
        ...
        client = SyncHttpClient("https://api.hivekey.ai", "mgent-bad")
        with pytest.raises(HivekeyError) as exc_info:
            client.get("/v0/whoami")
...
class TestAsyncHttpClient:
    ...
    async def test_get_success(self):
        respx.get("https://api.hivekey.ai/v0/whoami").mock(
            return_value=httpx.Response(200, json={"identityId": "id-123"}))
        client = AsyncHttpClient("https://api.hivekey.ai", "mgent-test")
